...
class Transformer_block(nn.Module):
    def __init__(self,d_model:int, num_heads:int,d_ff:int,use_rope=False,theta=None,max_seq_len=None,device=None,dtype=None):
        super().__init__()
...
class TransformerLM(nn.Module):
    def __init__(self,vocab_size:int, context_length:int, num_layers:int, d_model:int, num_heads:int,d_ff:int,use_rope=False,theta=None,device=None,dtype=None):
        super().__init__()
